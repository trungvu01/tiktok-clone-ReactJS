...
export const MessagesIcon = ({ width = '2rem', height = width, className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const InboxIcon = forwardRef(({ width = '2rem', height = width, className }, ref) => (
    <svg
        ref={ref}
        className={className}
        width={width}
...
export const UserIcon = ({ width = '2rem', height = width, className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const FavorIcon = ({ width = '2rem', height = width, className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const CoinsIcon = ({ width = '2rem', height = width, className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const SettingsIcon = ({ width = '2rem', height = width, className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const LiveIcon = ({ width = '2rem', height = width, className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const LogoutIcon = ({ width = '2rem', height = width, className }) => (
    <svg
        className={className}
        width={width}
        height={height}
